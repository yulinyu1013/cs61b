  ...
  public int[] next() throws NoSuchElementException {
    ...
    // Replace the following line with your solution.
	  int[] run = new int[4];
		  ...
		  run[0]=this.pointer.red;
		  run[1]=this.pointer.blue;
		  run[2]=this.pointer.green;
		  run[3]=this.pointer.runlength;
