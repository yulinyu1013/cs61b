...
public class BinaryTree implements Dictionary {
  ...
  public Entry remove(Object key) {
    // Replace the following line with your solution.
	  BinaryTreeNode toBeRemoved = findHelper((Comparable)key, root);
	  
	  if(toBeRemoved != null) {
		  Entry removed = toBeRemoved.entry;
		  
		  
		  if(toBeRemoved.leftChild==null&&toBeRemoved.rightChild==null) {//having no child
			  toBeRemoved.parent = null;
			  toBeRemoved = null;
			  
		  }else if(toBeRemoved.leftChild!=null&&toBeRemoved.rightChild==null) {//having left child
			  if(toBeRemoved.parent==null) { //root
				  toBeRemoved = toBeRemoved.leftChild;
				  
			  }else {
				  if(toBeRemoved.parent.leftChild==toBeRemoved) {
					  toBeRemoved.parent.leftChild = toBeRemoved.leftChild;
					  
				  }else {
					  toBeRemoved.parent.rightChild = toBeRemoved.leftChild;
				  }
		  ...
		  }else if(toBeRemoved.leftChild==null&&toBeRemoved.rightChild!=null) {//having right child
			  if(toBeRemoved.parent==null) {
				  toBeRemoved = toBeRemoved.rightChild;
				  
			  }else {
				  if(toBeRemoved.parent.leftChild==toBeRemoved) {
					  toBeRemoved.parent.leftChild = toBeRemoved.rightChild;
			  ...
			  BinaryTreeNode rightMin = toBeRemoved.rightChild;
			  while(rightMin.leftChild!=null) {
				  rightMin = rightMin.leftChild;
			  }
			  toBeRemoved.entry = rightMin.entry;
