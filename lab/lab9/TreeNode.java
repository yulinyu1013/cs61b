...
public abstract class TreeNode {
   ...
   *  Performance:  runs in O(1) time.
   */
  public Object item() throws InvalidNodeException2 {
    if (isValidNode()) {
      return item;
    } else {
   ...
   *  Performance:  runs in O(1) time.
   */
  public void setItem(Object item) throws InvalidNodeException2 {
    if (isValidNode()) {
      this.item = item;
    } else {
      throw new InvalidNodeException2();
   ...
   */
  public abstract TreeNode parent() throws InvalidNodeException2;
   ...
   *  cth child.
   */
  public abstract TreeNode child(int c) throws InvalidNodeException2;
   ...
   */
  public abstract TreeNode nextSibling() throws InvalidNodeException2;
   ...
   */
  public abstract void removeLeaf() throws InvalidNodeException2;
